...
// import 'features/auth/data/datasources/firebase_driver_auth_datasource.dart'; // Uncomment when Firebase Auth is enabled
...
Future<void> init() async {
  // Auth (Mock for testing — swap to FirebaseDriverAuthDataSource when Firebase Auth is enabled)
  sl.registerFactory(() => DriverAuthBloc(dataSource: sl()));
  sl.registerLazySingleton<DriverAuthDataSource>(() => MockDriverAuthDataSource());
